...
export const DEVICES_EXCEL_TO_DB: Record<string, string> = {
  ...
  '设备件号': '设备件号', '设备供应商件号': '设备件号',
  '设备供应商名称': '设备供应商名称', '设备供应商名': '设备供应商名称',
  '设备所属ATA': '设备所属ATA', '设备所属系统': '设备所属ATA', '设备/部件所属系统（4位-ATA）': '设备所属ATA',
  '设备安装位置': '设备安装位置',
  '设备DAL': '设备DAL',
  '壳体是否金属': '壳体是否金属', '设备壳体是否金属': '壳体是否金属',
  '金属壳体表面处理': '金属壳体表面处理', '金属壳体表面是否经过特殊处理而不易导电': '金属壳体表面处理',
  '设备内共地情况': '设备内共地情况',
  '壳体接地需求': '壳体接地需求', '设备壳体接地方式': '壳体接地需求',
  '壳体接地是否故障电流路径': '壳体接地是否故障电流路径', '壳体接地是否作为故障电流路径': '壳体接地是否故障电流路径',
  '其他接地特殊要求': '其他接地特殊要求',
  '设备端连接器数量': '设备端连接器数量', '设备端连接器/接线柱数量': '设备端连接器数量',
  '是否选装设备': '是否选装设备', '是否为选装设备': '是否选装设备',
  '设备装机架次': '设备装机架次',
  '设备负责人': '设备负责人',
  '额定电压': '额定电压',
  '额定电流': '额定电流',
...
export const CONNECTORS_EXCEL_TO_DB: Record<string, string> = {
  ...
  '设备端元器件编号': '设备端元器件编号',
  '元器件名称及类型': '元器件名称及类型', '设备端元器件名称及类型': '元器件名称及类型',
  '元器件件号及类型': '元器件件号及类型', '设备端元器件件号类型及件号': '元器件件号及类型',
  '元器件供应商名称': '元器件供应商名称', '设备端元器件供应商名称': '元器件供应商名称',
  '匹配线束端元器件件号': '匹配线束端元器件件号', '匹配的线束端元器件件号（推荐）': '匹配线束端元器件件号',
  '匹配线束线型': '匹配线束线型', '匹配的线束线型（推荐）': '匹配线束线型',
  '是否随设备交付': '是否随设备交付', '设备端元器件匹配的元器件是否随设备交付': '是否随设备交付',
  '备注': '备注',
};
